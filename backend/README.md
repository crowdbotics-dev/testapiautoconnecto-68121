...
## Project Structure
    ...
    ├── testapiautoconnecto_68121  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_68121`
...
2. Clone this repo and `cd testapiautoconnecto_68121`
